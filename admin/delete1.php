...
<body>
    <div id="wrapper">
        ...
        <div id="detail">
            <br>
            <center>
                <table class="table table-striped table-hover table-bordered" cellpadding="6px"
                    style="width:84%;font-size: 14px;">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="delete.php?id=<?php echo $rows['id']; ?>" onClick="return confirm_delete()"><button
