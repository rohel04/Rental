...
<body>
    ...
    ?>
    <div id="banner">
        <img class="myslide" src="design/bannerdis2.jpg" style="height: 260px;"></a>
    ...
    <div id="wrapper">
        ...
        <div id="content">
                ...
                <center>
                    <div id="sort" style="float:right; padding-right:7%;">
                        ...
                        <span><select class="form-select" id="s1" aria-label="Default select example"
                                ...
                                <option value="one" selected>High-Low</option>
            ...
            if (isset($_POST['bsearch'])) {
                ...
                $sql = "select p.*,b.p_id from tbl_property p left join tbl_booking b on p.id=b.p_id order by price DESC";
            }
            $result = $conn->query($sql);
